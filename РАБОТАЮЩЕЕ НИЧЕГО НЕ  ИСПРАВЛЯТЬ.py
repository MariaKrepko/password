...
class Login(Toplevel ):
    ...
    def entry(self):                                                    #тут нужно добавить функцию хэша
    ...
    def registration(self):
        ...
        self.PassworText = Text(centerFrame, height=1, borderwidth=1)
        self.PassworText.place(relx= 0.2 ,rely = 0.4 , relwidth=0.6, relheight=0.1)
    ...
    def init(self):
        if os.path.exists('Passwords.db') is True:
            self.authorization()
        else:
            self.registration()
